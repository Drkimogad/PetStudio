    ...
    event.respondWith(
        caches.match(event.request).then((cachedResponse) => {
            ...
            if (event.request.mode === 'navigate') {
                return caches.match('https://drkimogad.github.io/PetStudio/index.html');  // Ensure offline.html is cached
            }
            ...
            return caches.match('https://drkimogad.github.io/PetStudio/index.html');
        })
    );
});
